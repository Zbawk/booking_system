...
<body>
            ...
            <nav class="navbar navbar-expand-xl py-0">
                <div class="logo">
                    <a class="navbar-brand py-0 me-0" href="#">
                        <img style="width:20vh; position:relative; left:-15%;" src="assets/images/PD.jpg"
                            alt="logo">
                    </a>
                </div>
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <div class="d-flex align-items-center">
                        <a class="btn btn-primary border border-outline-white btn-outline-light btn-hover-secondery text-capitalize "
                            href="#">Account</a>
                    </div>
                </div>
            </nav>
            ...
            <div class="offcanvas-header">
                <div class="logo">
                    <a class="navbar-brand py-0 me-0" href="#"><img
                            src="{{ asset('assets/images/Creato-logo.svg') }}" alt=""></a>
                </div>
    ...
    <section class="hero-banner position-relative overflow-hidden">
        <div class="container owl-carousel owl-theme landing-slider">
            ...
            <div class="row d-flex flex-wrap align-items-center item">
                <div class="col-xxl-6 col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                    <div class="position-relative left-hero-color">
                        ...
                        <p style="line-height:1.6em">The project management tool you love The project management tool
                            you love. The project management tool you love..</p>
                        <a href="#" class="btn btn-primary btn-hover-secondery"><span
                                class="d-inline-block me-2"><i class="ti ti-playstation-triangle"></i></span> Hire For
                            Events</a>
                    </div>
                </div>
                <div class="col-xxl-6 col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
            ...
            <div class="row d-flex flex-wrap align-items-center item">
                ...
                <div class="col-xxl-6 col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                    <div class="position-relative right-hero-color">
                        <img src="{{ asset('assets/images/events_dj.jpg') }}" class="img-fluid">
                    </div>
                </div>
            </div>
        ...
        <div class="container position-relative mb-5">
            <div class="row">
                ...
                <div
                    ...
                    <a href="#" class="btn btn-primary border  btn-hover-secondery section-btn">Hire Us</a>
                </div>
            </div>
        </div>
                ...
                <div class="owl-carousel owl-theme portfolio-slider">
                    <div class="item">
                        <a href="#"><img style="border-radius:0"
                                src="{{ asset('assets/images/Dj-Speakers-800x445.jpg') }}" class="w-100"></a>
                    </div>
                    <div class="item">
                        <a href="#"><img style="border-radius:0"
                                src="{{ asset('assets/images/Dj-Speakers-800x445.jpg') }}" class="w-100"></a>
                ...
                <div class="col-xxl-4 col-xl-4 col-lg-4 col-md-6 col-sm-6 col-12">
                    <div class="card position-relative shadow border-0 h-100">
                        ...
                        <div class="card-action text-center pb-xxl-5 pb-xl-5 pb-lg-5 pb-md-4 pb-sm-4 pb-4">
                            <a href="#" class="btn btn-primary btn-hover-secondery text-capitalize">Set
                                Started</a>
                        </div>
                    </div>
                </div>
    ...
    <section class="contact bg-primary position-relative overflow-hidden">
        <div class="container position-relative">
            <div class="dots-shape-left position-absolute"><img
                    src="{{ asset('assets/images/icons/dot-shape.png') }}"></div>
                            ...
                            <div class="details position-relative">
                                ...
                                <div class="d-flex align-items-center">
                                    <div class="avtar-img rounded-circle overflow-hidden"><img
                                            src="{{ asset('assets/images/contact/testimonial-image.png') }}"
                                            class="img-fluid">
                                    </div>
                                    <div class="name ps-3">
                        ...
                        <div class="row ps-xxl-5 ps-xl-5 ps-lg-3 ps-md-0 ps-sm-0 ps-0">
                            ...
                            <div class="agree fs-7 fw-500">
                                By clicking on the Sign Up button, you agree to Rakon.<br><a href="#"
                                    class="text-primary text-decoration-none">terms and conditions of use.</a>
                            </div>
                            <div class="col-12">
                                <button
                                    class="btn btn-light btn-hover-secondery text-capitalize mt-2 w-auto contact-btn">Try
                                    for Free</button>
                            </div>
                        </div>
                    </form>
            ...
            <div class="row">
                <div class="col-xxl-4 col-xl-4 col-lg-4 col-md-6 col-sm-12">
                    <div class="footer-logo-col">
                        <p class="blue-light mb-0 fs-7 fw-500">PDEntertainment is a company that works on events like
                            weddings ,parties, we also do hires for equipments.</p>
                        <div class="callus text-white fw-500 fs-7">
                            Blantyre
                            <div class="blue-light">Call us: <a href="#"
                                    class="text-primary fw-500 fs-7 text-decoration-none">808-956-9599</a></div>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-xxl-4 col-xl-4 col-lg-4 col-md-6 col-sm-12">
                    <div class="subscribe">
                        ...
                        <div class="input-group">
                            ...
                            <button
                                class="btn btn-primary btn-hover-secondery ms-xxl-2 ms-xl-2 ls-lg-0 ms-md-0 ms-sm-0 ms-0"
                                type="button" id="button-addon2">Register</button>
                        </div>
                    </div>
                </div>
            </div>
            <div class="copyrights text-center blue-light  fw-500">@<span id="autodate">2023</span> -
                pdentertainment</a>
            </div>
        </div>
    </footer>
    ...
    <script src="{{ asset('assets/index.global.min.js') }}"></script>
    <script>
